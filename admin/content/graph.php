...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            trazar sus estadísticas de venta
        </small>
    </h1>
</div><!-- /.page-header -->
<div class="row">
            ...
            <div class="widget-header widget-header-flat">
                ...
                <div class="widget-toolbar no-border">
                    ...
                    <select id="graphinterval" onchange="setGraphInterval();" style="margin-right: 5px;">
                        <option value="86400000" selected="selected">Día</option>
                        <option value="604800000">Semana</option>
                        <option value="1209600000">Quincena</option>
                        <option value="2629743833">Mes</option>
                        <option value="7889231500">3 Meses</option>
                        <option value="31556926000">Año</option>
                    </select>
                    <label>Rango: <input type="text" style="width: 85px;" id="graphstime" onclick="$(this).blur();" /></label>
                    <label>a <input type="text" style="width: 85px;" id="graphetime" onclick="$(this).blur();" /></label>
                </div>
            </div>
    ...
    <div class="col-sm-6">
        ...
        <div class="widget-body" style="text-align: center; padding-top: 10px;">
            <select id="datasetselect">
                <option value="method">Métodos de pago</option>
                <option value="device">Recaudación de dispositivos</option>
                <option value="location">Recaudación de ubicaciones</option>
            </select>
            <button onclick="userLoadDataSet();" class="btn btn-sm btn-primary">Agregar</button>
        </div>
        </div>
    </div>
    <div class="col-sm-6">
        ...
        <div class="widget-body">
            ...
            <ol id="datasets" class="ddlist" style="margin-left: 0; padding-left: 0;">
                <li class="dd-item">
                    <div class="dd2-content">Total de ventas
                ...
                <li class="dd-item">
                    <div class="dd2-content">Reembolso total
                ...
                <li class="dd-item">
                    <div class="dd2-content">Ingresos
                ...
                <li class="dd-item">
                    <div class="dd2-content">Lucro / Profit
...
<script type="text/javascript">
    ...
    async function getData(action){
        // fetch the data
        return await WPOS.sendJsonData(action, JSON.stringify({"stime": stime, "etime": etime, "interval": $("#graphinterval").val()}));
    }
