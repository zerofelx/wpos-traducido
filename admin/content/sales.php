...
<div class="page-header">
    ...
    <button class="btn btn-success btn-sm pull-right" onclick="exportCurrentSales();"><i class="icon-cloud-download align-top bigger-125"></i>Exportar CSV</button>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="table-header">
                    Ver y buscar transacciones POS
                </div>
                    ...
                    <table id="salestable" class="table table-striped table-bordered table-hover dt-responsive" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="8">Usuario</th>
                                <th data-priority="3">Dispositivo / Ubicación</th>
                                <th data-priority="9"># Artículos</th>
                                <th data-priority="4">Tiempo de venta</th>
...
<script type="text/javascript">
    ...
    async function reloadSalesData(){
        ...
        resetSearchBox();
        var sales = await WPOS.sendJsonData("sales/get", JSON.stringify({"stime":stime, "etime":etime}));
    ...
    function getStatusHtml(status){
        ...
        switch(status){
            ...
            case 2:
                ...
                break;
            case 3:
                stathtml='<span class="label label-warning arrowed">Reembolzado</span>';
                break;
            default:
