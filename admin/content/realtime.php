...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            Ver las ventas a medida que ocurren
        </small>
    </h1>
</div><!-- /.page-header -->
<div class="row">
            ...
            <div class="widget-body">
                <div class="widget-main no-padding">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr id="nosalesrow">
                            <td colspan="5" style="text-align: center;"><strong>No hay ventas por hoy</strong></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="widget-box transparent">
            <div class="widget-header widget-header-flat">
                <h4 class="lighter">
                    ...
                    Dispositivos y mensajería en línea
                </h4>
            </div>
                    ...
                    <div class="col-sm-6" style="margin: 0;">
                        ...
                        <table style="width: 100%" class="table">
                            ...
                            <tr>
                                <th>
                                    <i class="icon-caret-right blue"></i>
                                    <h4 class="lighter blue" style="display: inline-block;">Dispositivos de mensaje</h4>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>
                                    ...
                                    <div style="text-align: center;">
                                        ...
                                        <button class="btn btn-danger btn-sm" onclick="sendReset();">Reiniciar terminal</button>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="col-sm-6" style=" vertical-align: top; margin: 0;">
                        <table style="width: 100%" class="table table-striped">
                            ...
                            <tr>
                                <th>
                                    <i class="icon-caret-right blue"></i>
                                    <h4 class="lighter blue" style="display: inline-block;">Dispositivos en linea</h4>
                                </th>
                            </tr>
                            </thead>
                            <tbody id="onlinedevices">
                            <tr><td style="text-align: center;">Cargando...</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="widget-body" style="padding-top: 10px; text-align: center;">
            ...
            <div class="infobox infobox-red infobox-voids">
                ...
                <div class="infobox-data">
                    ...
                    <div class="infobox-content">Anulados</div>
                </div>
            ...
            <div class="infobox infobox-orange infobox-cost">
                ...
                <div class="infobox-data">
                    ...
                    <div class="infobox-content">Costo</div>
                </div>
            </div>
...
async function sendMessage() {
    ...
    var result;
    if (devid == "all") {
        result = await WPOS.sendJsonData("message/send", JSON.stringify({message: msg, device: null}));
    } else {
        result = await WPOS.sendJsonData("message/send", JSON.stringify({message: msg, device: devid}));
    }
    if (result!==false){
        $("#msgtext").val('');
    }
...
async function sendReset() {
    ...
    var result;
    if (devid == "all") {
        result = await WPOS.sendJsonData("device/reset", JSON.stringify({device: null}));
    } else {
        result = await WPOS.sendJsonData("device/reset", JSON.stringify({device: devid}));
    }
    if (result!==false){
...
async function reloadGraph(){
    ...
    // fetch the data
    var data = await WPOS.sendJsonData("graph/general", JSON.stringify({"stime": stime, "etime": etime, "interval": 1800000})); // interval half an hour
...
$(function () {
    (async () => {
        ...
        // load data
        WPOS.startSocket();
        var data = await WPOS.sendJsonData("multi", JSON.stringify({"sales/get":{stime: stoday, etime: etime}, "stats/general":{"stime":stoday, "etime":etime}, "graph/general":{"stime": stime, "etime": etime, "interval": 1800000}}));
        if (data!==false) {
