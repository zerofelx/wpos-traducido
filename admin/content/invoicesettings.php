...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            Administrar la configuración de facturas y cuentas
        </small>
    </h1>
</div><!-- /.page-header -->
<div class="row">
        ...
        <div class="widget-box transparent">
            ...
            <div class="widget-body" style="padding-top: 10px;">
                ...
                <div class="form-group">
                    <div class="col-sm-2"><label>Fecha de vencimiento predeterminada:</label></div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="col-sm-2"><label>Plantilla predeterminada:</label></div>
                    <div class="col-sm-6">
                ...
                <div class="space-4"></div>
                <div class="form-group">
                    <div class="col-sm-2"><label>Instrucciones de pago:</label></div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-2"><label>Mensaje de correo electrónico:</label></div>
                        <div class="col-sm-6" style="max-width: 650px;">
...
<script type="text/javascript">
    ...
    async function saveSettings(){
        ...
        var result = await WPOS.sendJsonData("settings/invoice/set", JSON.stringify(data));
        if (result !== false){
    ...
    async function loadSettings(){
        options = await WPOS.getJsonData("settings/invoice/get");
