        ...
        <div class="widget-header widget-header-flat">
            ...
            <div class="widget-toolbar no-border">
                <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown">
                    <span id="grange">Esta semana</span>
                ...
                <ul id="grangevalues" class="dropdown-menu pull-right dropdown-125 dropdown-lighter dropdown-caret">
                    <li onclick="setGraph($(this));" class="active" >
                        <a class="blue">
                            ...
                            <span class="grangeval">Esta semana</span>
                        </a>
                    </li>
                    ...
                    <li onclick="setGraph($(this));">
                        <a>
                            ...
                            <span class="grangeval">Ultima semana</span>
                        </a>
                    </li>
                    ...
                    <li onclick="setGraph($(this));">
                        <a>
                            <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                            <span class="grangeval">Este mes</span>
                        </a>
                    </li>
                    ...
                    <li onclick="setGraph($(this));">
                        <a>
                            <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                            <span class="grangeval">Último mes</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="widget-box transparent">
            <div class="widget-header widget-header-flat">
                <h4 class="lighter">
                    ...
                    Artículos populares de este mes
                </h4>
            </div>
    ...
    <div class="col-sm-7">
        ...
        <div class="widget-box">
            <div class="widget-header widget-header-flat widget-header-small">
                ...
                <div class="widget-toolbar no-border" style="float: none; display: inline-block; vertical-align: top;">
                    ...
                    <ul id="pietypevalues" class="dropdown-menu pull-right dropdown-125 dropdown-lighter dropdown-caret">
                        <li onclick="setPieType($(this));" class="active">
                            <a class="blue">
                                <i class="icon-caret-right bigger-110">&nbsp;</i>
                                <span class="pietypeval">Pagos</span>
                            </a>
                        </li>
                        ...
                        <li onclick="setPieType($(this));">
                            <a>
                                <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                                <span class="pietypeval">Dispositivos</span>
                            </a>
                        </li>
                        ...
                        <li onclick="setPieType($(this));">
                            <a>
                                <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                                <span class="pietypeval">Ubicaciones</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="widget-toolbar no-border">
                    <button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown">
                        <span id="pierange">Esta semana</span>
                        <i class="icon-angle-down icon-on-right bigger-110"></i>
                    </button>
                    ...
                    <ul id="pierangevalues" class="dropdown-menu pull-right dropdown-125 dropdown-lighter dropdown-caret">
                        <li onclick="setPie($(this));" class="active" >
                            <a class="blue">
                                <i class="icon-caret-right bigger-110">&nbsp;</i>
                                <span class="pierangeval">Esta semana</span>
                            </a>
                        </li>
                        ...
                        <li onclick="setPie($(this));">
                            <a>
                                <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                                <span class="pierangeval">Última semana</span>
                            </a>
                        </li>
                        ...
                        <li onclick="setPie($(this));">
                            <a>
                                <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                                <span class="pierangeval">Este mes</span>
                            </a>
                        </li>
                        ...
                        <li onclick="setPie($(this));">
                            <a>
                                <i class="icon-caret-right bigger-110 invisible">&nbsp;</i>
                                <span class="pierangeval">Último mes</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="clearfix">
                        <div class="grid3">
															<span class="grey">
																...
																&nbsp;<span id="piesalenum">-</span> ventas
															</span>
                        ...
                        <div class="grid3">
															<span class="grey">
																...
																&nbsp;<span id="pierefundnum">-</span> reembolsos
															</span>
...
<script type="text/javascript">
    ...
    async function reloadPieChart(){
        ...
        // fetch the data
        var data = await WPOS.sendJsonData(vals[0], JSON.stringify({"stime":vals[1], "etime":vals[2], "totals":true}));
    ...
    async function reloadGraph(){
        ...
        // fetch the data
        var jdata = await WPOS.sendJsonData("graph/general", JSON.stringify({"stime":vals[0], "etime":vals[1], "interval":86400000}));
        drawGraph(jdata);
        // hide loader
        WPOS.util.hideLoader();
    }
    ...
    jQuery(async function($) {
        ...
        var tooltip = async function (event, pos, item) {
            if(item) {
        ...
        var data = await WPOS.sendJsonData("multi", JSON.stringify(req));
        // Load todays stats
