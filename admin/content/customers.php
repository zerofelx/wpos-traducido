...
<div class="page-header">
    ...
    <button onclick="WPOS.customers.openAddCustomerDialog();" id="addbtn" class="btn btn-primary btn-sm pull-right"><i class="icon-pencil align-top bigger-125"></i>Agregar</button>
    <button class="btn btn-success btn-sm pull-right" style="margin-right: 10px;" onclick="exportCustomers();"><i class="icon-cloud-download align-top bigger-125"></i>Exportar CSV</button>
</div><!-- /.page-header -->
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="table-header">
                    Administre su base de clientes
                </div>
                    ...
                    <table id="customertable" class="table table-striped table-bordered table-hover dt-responsive" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <th data-priority="7" >Ciudad</th>
                            <th data-priority="8" >Código postal</th>
